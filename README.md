...
Student: Garcia, Ethan Course: ENGR 4399 ST: Cyber-Physical & IoT Systems Instructor: Dr. Okan Caglayan Semester: Fall 2026
...
How It Works
The ESP32 sends a short trigger pulse to the HC-SR04.
The sensor returns an echo pulse whose duration corresponds to the round-trip time of the ultrasonic pulse.
That duration is converted to a distance in centimeters.
The distance is clamped to a defined range (2 to 30 cm) and mapped to a servo angle (0 to 180 degrees).
The servo moves to that angle, acting as the gauge needle, and the distance/angle pair is printed to Serial.
Simulation
...
Ethan Garcia GitHub: github.com/etgarcia02
